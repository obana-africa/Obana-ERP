...
const TAX_REGIONS = [
  ...
  { id:'EU', name:'European Union',       flag:'🇪🇺', collecting:null,    service:'thaja Tax',   rate:20,   vatNum:'' },
  ...
  { id:'GB', name:'United Kingdom',       flag:'🇬🇧', collecting:null,    service:'thaja Tax',   rate:20,   vatNum:'' },
]

const SERVICE_COLORS = {
  'Manual Tax': { bg:'#F3F4F6', color:'#374151' },
  'Basic Tax':  { bg:'#EFF6FF', color:'#1D4ED8' },
  'thaja Tax':   { bg:'#E6F7F2', color:'#047857' },
}
  ...
  return (
    <div className={styles.panel}>
      ...
      <div className={styles.section}>
        <div className={styles.builtByLabel}>Built by thaja</div>
        <div className={styles.serviceRow}>
          ...
          <div className={styles.serviceInfo}>
            <div className={styles.serviceNameRow}>
              <span className={styles.serviceName}>thaja tax services</span>
      ...
      <div className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          <div className={styles.taxServiceRow}>
            ...
            <span className={styles.tsName}>thaja tax services</span>
