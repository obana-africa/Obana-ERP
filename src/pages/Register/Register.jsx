...
export default function Register() {
  ...
  const startTimer = () => {
    timerRef.current = setInterval(() =>
      setCurrent(c => (c + 1) % TESTIMONIALS.length), 5000)
  }
  useEffect(() => {
    startTimer()
  ...
  const handleSubmit = e => {
    e.preventDefault()
    setSubmitted(true)
    // TODO: authService.register(form) when backend is ready
        ...
        <div className={styles.formWrapper}>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <button
              ...
              disabled={submitted || !form.terms}>
              {submitted
                ? '✓ Account created!'
                : <><span>Create free account</span><span className={styles.arrow}>→</span></>
              }
            </button>
          </form>
