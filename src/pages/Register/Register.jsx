...
const TESTIMONIALS = [
  {
    text: "thaja completely changed how I run my fashion business. I used to spend hours tracking orders on paper — now everything is automated and I can focus on selling.",
  ...
  {
    text: "I started getting international orders within a week of setting up my thaja store. The analytics helped me understand which products were actually selling.",
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('thaja_user', JSON.stringify(userData))
