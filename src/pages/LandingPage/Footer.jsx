    ...
    <footer className={styles.footer}>
      <div className={styles.footerTop}>
        <div className={styles.footerBrandCol}>
          <img src="/logos/taoja logo.png" alt="taoja" className={styles.footerLogo} />
        ...
        <div className={styles.footerCols}>
          <div className={styles.footerCol}>
            <p className={styles.footerColTitle}>About taoja</p>
          ...
          <div className={styles.footerCol}>
            ...
            <a href="#" className={styles.footerLink}>Sell on taoja</a>
      ...
      <div className={styles.footerBottom}>
        <div className={styles.footerBottomLeft}>
          <p className={styles.footerCopy}>
            © 2025 taoja.Africa (An ICON Tech &amp; Ecom Services Ltd Trademark). <br />All Rights Reserved.{' '}
            <br />
