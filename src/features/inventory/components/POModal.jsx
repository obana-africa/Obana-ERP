...
import { SAMPLE_INVENTORY } from '@/data/inventory'; // temporary until service

export default function POModal({ suppliers, onClose, onSave }) {
    ...
    <div className={s.overlay} onClick={e => e.target === e.currentTarget && onClose()}>
      <div className={s.modal}>
        ...
        <div className={s.mFoot}>
          ...
          <button className={s.btnPrimary} disabled={!form.supplier} onClick={() => onSave({ ...form, items, total })}>
